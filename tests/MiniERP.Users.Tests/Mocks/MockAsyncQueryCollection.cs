...
namespace MiniERP.Users.Tests.Mocks

{
    public static class MockAsyncQueryCollection
    {
    ...
    internal class TestAsyncEnumerator<T>(IEnumerator<T> inner) : IAsyncEnumerator<T>
    {
        ...
        public ValueTask<bool> MoveNextAsync() => new(Task.FromResult(_inner.MoveNext()));
